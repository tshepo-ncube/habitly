...
const LandingPage: React.FC<LandingPageProps> = ({ onGoogleLogin, onMicrosoftLogin }) => {
  return (
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6">
            Build Better
            <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent"> Habits</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Transform your daily routine with beautiful habit tracking. Stay motivated with streaks, 
            reflect on your progress, and build the life you want.
          </p>
              ...
              <div className="space-y-3">
                <div className="bg-gradient-to-r from-yellow-400 to-orange-400 p-3 rounded-xl flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-white font-medium">Morning Coffee</span>
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Powerful features designed to help you build lasting habits and track your progress.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Stay motivated with visual streak counters that celebrate your consistency.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Progress Insights</h3>
              <p className="text-gray-600">Reflect on your daily progress with built-in journaling features.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Enjoy a clean, intuitive interface that makes habit tracking delightful.</p>
            </div>
          </div>
        </div>
      </section>
